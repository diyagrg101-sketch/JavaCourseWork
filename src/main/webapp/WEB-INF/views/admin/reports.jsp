    ...
    <div class="main-content">
        ...
        <div class="report-grid">
            ...
            <div class="chart-card">
                <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:16px">
                    ...
                    <select class="filter-select" style="font-size:.76rem;padding:5px 10px"><option>Daily</option><option>Weekly</option><option>Monthly</option></select>
                </div>
                <!-- SVG line chart mock -->
                <div class="line-chart">
                    <svg viewBox="0 0 560 160" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
                        ...
                        <path d="M0,120 C30,110 50,90 80,95 C110,100 130,60 160,50 C190,40 210,70 240,55 C270,40 290,30 320,35 C350,40 370,25 400,20 C430,15 450,40 480,38 C510,36 540,50 560,45 L560,160 L0,160 Z"
                              fill="url(#areaGrad)"/>
                        <!-- line -->
                        <path d="M0,120 C30,110 50,90 80,95 C110,100 130,60 160,50 C190,40 210,70 240,55 C270,40 290,30 320,35 C350,40 370,25 400,20 C430,15 450,40 480,38 C510,36 540,50 560,45"
                              fill="none" stroke="#C8680A" stroke-width="2.5" stroke-linejoin="round"/>
                        <!-- dots -->
            ...
            <div class="chart-card">
                ...
                <div class="donut-wrap">
                    <svg class="donut-svg" viewBox="0 0 42 42" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <!-- segments: total circumference = 100 -->
        ...
        <div class="report-grid" style="margin-bottom:18px">
            ...
            <div class="chart-card">
                ...
                <div class="h-bars">
                    <div class="h-bar-row">
                        <span class="h-bar-label">Hazelnut Cappuccino</span>
                        <div class="h-bar-track"><div class="h-bar-fill" style="width:85%"></div></div>
                        <span class="h-bar-val">248 orders</span>
                    </div>
                    <div class="h-bar-row">
                        <span class="h-bar-label">Butter Croissant</span>
                        <div class="h-bar-track"><div class="h-bar-fill" style="width:75%;background:#F0A84A"></div></div>
                        <span class="h-bar-val">312 orders</span>
                    </div>
                    <div class="h-bar-row">
                        <span class="h-bar-label">Himalayan Salt Tea</span>
                        <div class="h-bar-track"><div class="h-bar-fill" style="width:65%;background:#1565C0"></div></div>
                        <span class="h-bar-val">184 orders</span>
                    </div>
                    <div class="h-bar-row">
                        <span class="h-bar-label">Paneer Tikka Wrap</span>
                        <div class="h-bar-track"><div class="h-bar-fill" style="width:55%;background:#2E7D32"></div></div>
                        <span class="h-bar-val">142 orders</span>
                    </div>
                    <div class="h-bar-row">
                        <span class="h-bar-label">Blueberry Cheesecake</span>
                        <div class="h-bar-track"><div class="h-bar-fill" style="width:40%;background:#9C27B0"></div></div>
                        <span class="h-bar-val">96 orders</span>
                    </div>
                    <div class="h-bar-row">
                        <span class="h-bar-label">Avocado Toast</span>
                        <div class="h-bar-track"><div class="h-bar-fill" style="width:30%;background:#E65100"></div></div>
                        <span class="h-bar-val">74 orders</span>
                    </div>
                </div>
            </div>
        ...
        <div class="admin-table-card" style="margin-bottom:18px">
            ...
            <table>
                ...
                <tbody>
                <tr>
                    <td style="font-weight:600">Oct 24, 2024</td>
                    <td>18</td><td>4</td>
                    <td style="font-weight:700">NPR 5,240</td>
                    <td>NPR 291</td>
                    <td>Hazelnut Cappuccino</td>
                    <td><span style="color:var(--green);font-weight:600">↗ +14%</span></td>
                </tr>
                <tr>
                    <td style="font-weight:600">Oct 23, 2024</td>
                    <td>15</td><td>2</td>
                    <td style="font-weight:700">NPR 4,590</td>
                    <td>NPR 306</td>
                    <td>Butter Croissant</td>
                    <td><span style="color:var(--red);font-weight:600">↘ -5%</span></td>
                </tr>
                <tr>
                    <td style="font-weight:600">Oct 22, 2024</td>
                    <td>21</td><td>7</td>
                    <td style="font-weight:700">NPR 6,120</td>
                    <td>NPR 291</td>
                    <td>Himalayan Pink Salt Tea</td>
                    <td><span style="color:var(--green);font-weight:600">↗ +22%</span></td>
                </tr>
                <tr>
                    <td style="font-weight:600">Oct 21, 2024</td>
                    <td>14</td><td>3</td>
                    <td style="font-weight:700">NPR 3,850</td>
                    <td>NPR 275</td>
                    <td>Hazelnut Cappuccino</td>
                    <td><span style="color:var(--red);font-weight:600">↘ -8%</span></td>
                </tr>
                <tr>
                    <td style="font-weight:600">Oct 20, 2024</td>
                    <td>19</td><td>5</td>
                    <td style="font-weight:700">NPR 5,560</td>
                    <td>NPR 293</td>
                    <td>Blueberry Cheesecake</td>
                    <td><span style="color:var(--green);font-weight:600">↗ +9%</span></td>
                </tr>
                <tr>
                    <td style="font-weight:600">Oct 19, 2024</td>
                    <td>16</td><td>1</td>
                    <td style="font-weight:700">NPR 4,240</td>
                    <td>NPR 265</td>
                    <td>Paneer Tikka Wrap</td>
                    <td><span style="color:var(--green);font-weight:600">↗ +3%</span></td>
                </tr>
                </tbody>
            </table>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:18px;margin-bottom:18px">
            ...
            <div class="chart-card">
                ...
                <div class="h-bars" style="margin-top:16px">
                    <div class="h-bar-row">
                        <span class="h-bar-label">eSewa</span>
                        <div class="h-bar-track"><div class="h-bar-fill" style="width:52%"></div></div>
                        <span class="h-bar-val">52% &nbsp; (81)</span>
                    </div>
                    <div class="h-bar-row">
                        <span class="h-bar-label">Khalti</span>
                        <div class="h-bar-track"><div class="h-bar-fill" style="width:28%;background:#9C27B0"></div></div>
                        <span class="h-bar-val">28% &nbsp; (44)</span>
                    </div>
                    <div class="h-bar-row">
                        <span class="h-bar-label">Credit Card</span>
                        <div class="h-bar-track"><div class="h-bar-fill" style="width:13%;background:#1565C0"></div></div>
                        <span class="h-bar-val">13% &nbsp; (20)</span>
                    </div>
                    <div class="h-bar-row">
                        <span class="h-bar-label">Cash on Del.</span>
                        <div class="h-bar-track"><div class="h-bar-fill" style="width:7%;background:#888"></div></div>
                        <span class="h-bar-val">7% &nbsp;&nbsp; (11)</span>
                    </div>
                </div>
                <div style="background:var(--orange-bg);border-radius:var(--r-sm);padding:12px 14px;margin-top:16px;font-size:.8rem;color:var(--text-mid)">
                    <strong style="color:var(--orange)">💡 Insight:</strong> eSewa continues to be the dominant payment method. Consider adding eSewa promotional offers to drive more orders.
                </div>
            </div>
        </div>
        ...
        <div class="chart-card" style="margin-bottom:18px">
            ...
            <div style="margin-top:10px;font-size:.78rem;color:var(--text-muted);text-align:center">
                Peak hours: <strong style="color:var(--orange)">9–10 AM</strong> and <strong style="color:var(--orange)">7–8 PM</strong>. Consider increasing staffing during these windows.
            </div>
        </div>
...
<script>
    function setRange(event){
        document.querySelectorAll('.report-controls .btn')
            .forEach(b => {
