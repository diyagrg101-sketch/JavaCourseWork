...
<div class="sidebar-layout">
    ...
    <div class="main-content">
        ...
        <!-- ═══════════════════════════════════════════════════════
             CUSTOMER REVIEWS — live from DB (feedback table)
             ═══════════════════════════════════════════════════════ -->
            ...
            <div class="review-header">
                <div>
                    ...
                    <div class="chart-card-sub">
                        <c:choose>
                            <c:when test="${not empty totalReviews}">
                        ...
                        <div class="review-item ${loop.index >= 3 ? 'extra-review' : ''} ${loop.last ? 'last-review' : ''}"
                            ...
                            <div style="flex:1">
                                ...
                                <div class="review-stars" style="color:#C8680A;font-size:.95rem;margin:3px 0">
                                    ...
                                    <%-- Product name — new field from schema join --%>
                                <c:if test="${not empty fb.productName}">
                                    ...
                                    <%-- review column (was message) --%>
                                <div class="review-text">${fn:escapeXml(fb.review)}</div>
                            </div>
